...
class ModelCompare():
    ...
    def run(self, game: BaseGame, args: dict, m_1: str = None, m_2: str = None, num_games: int = 100) -> None:
        ...
        if model_1 is None:
            model_1, model_2 = model_2, model_1  # Ensure model_1 is not None for consistency
    ...
    def play_games(self, game: BaseGame, model_1: ResNet, model_2: ResNet = None, num_games: int = 100) -> dict:
        results = {1: 0, -1: 0, 0: 0}  # Initialize win/draw counters

        with multiprocessing.Pool(processes=multiprocessing.cpu_count()) as pool:
            tasks = []
            for i in range(num_games):
                tasks.append(pool.apply_async(self.game_loop_worker, args=(game, model_1, model_2, i % 2 == 1)))
    ...
    def get_model(self, m: str, game: BaseGame, args: dict) -> ResNet:
    ...
    def handle_non_terminal(self, game: BaseGame, game_state: GameState) -> int:
        if not terminal:
    ...
    def save_results(self, model_1: str, model_2: str, results: dict) -> None:
    ...
    def game_loop_worker(self, game: BaseGame, model_1: ResNet, model_2: ResNet = None, flip_res: bool = False) -> int:
